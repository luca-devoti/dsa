from algorithms import selection_sort_largest, selection_sort_smallest, bubble_sort_default, bubble_sort_optimised
...
def test_bubble_sort():
    ...
    assert bubble_sort_default([1, 3, 5, 2, 4]) == [1, 2, 3, 4, 5]
    assert bubble_sort_optimised([1, 3, 5, 2, 4]) == [1, 2, 3, 4, 5]